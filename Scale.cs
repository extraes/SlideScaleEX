...
public class Scale : MelonMod {
    ...
    public override void OnInitializeMelon() 
    {
        ...
        Instances<WorldGrip>.TryAutoCache();
    ...
    {
        if (Instances<WorldGrip>.Has(grabbedObj))
        {
#if DEBUG
            Log($"Ignoring grabbed object {grabbedObj.transform.GetFullPath()} - it is a WorldGrip and will (obviously) not have anything we can scale.");
#endif
            return;
        }
