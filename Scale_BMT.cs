...
namespace Camo {
	public class Scale : MelonMod {
		...
		public override void OnApplicationStart() {
			...
			//EasyMenu
			MenuInterface menu = Interfaces.AddNewInterface("Slide Scale", Color.green);
			menu.CreateBoolElement("Mass Scaling", Color.white, massScale, ToggleMassScale);
			menu.CreateBoolElement("Show Ghosts", Color.white, showGhosts, ToggleGhosts);
			menu.CreateBoolElement("Mod Toggle", Color.white, globalToggle, ToggleGlobal);
		}

		public override void OnSceneWasInitialized(int buildIndex, string sceneName) {
			//Get controllers
			Player.TryGetControllers(out lController, out rController);
			lControllerT = lController.transform;
			rControllerT = rController.transform;

			//Hook to methods
			BoneworksModdingToolkit.BoneHook.PlayerHooks.OnPlayerGrabObjectHand += Grab;
			BoneworksModdingToolkit.BoneHook.PlayerHooks.OnPlayerReleaseObjectHand += Ungrab;
